    ...
    <div className="space-y-6">
      <div className="flex gap-4 flex-wrap">
        <div className="flex flex-col gap-1">
          <label
            htmlFor="readonly-cabana-select"
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-1 max-w-xs">
        <label
          htmlFor="readonly-concept-select"
          className="text-xs text-neutral-400"
        >
          Konsept
        </label>
  ...
  return (
    <div className="space-y-6">
      <div className="flex gap-4 flex-wrap">
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="calc-start-date" className="text-xs text-neutral-400">
            Başlangıç
          </label>
          <input
            id="calc-start-date"
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="calc-end-date" className="text-xs text-neutral-400">
            Bitiş
          </label>
          <input
            id="calc-end-date"
          ...
          <div className="flex justify-end">
            <div className="bg-neutral-800 rounded-lg px-6 py-4 text-right space-y-1">
              ...
              <div className="text-xs text-neutral-400">
                ...
                {breakdown.cabanaDaily.toFixed(2)} {sym}
              </div>
              <div className="text-xs text-neutral-400">
                Konsept ({breakdown.days} gün):{" "}
                {breakdown.conceptTotal.toFixed(2)} {sym}
              </div>
              <div className="text-xs text-neutral-400">
