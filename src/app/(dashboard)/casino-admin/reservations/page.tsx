...
export default function CasinoAdminReservationsPage() {
  ...
  const { data, isLoading, isFetching } = useQuery({
    queryKey: ["casino-admin-reservations", page, statusFilter, search],
  ...
  const actionMutation = useMutation({
    ...
    onMutate: async ({ action, id }) => {
      await queryClient.cancelQueries({ queryKey: ["casino-admin-reservations"] });
      const previousData = queryClient.getQueriesData<ReservationListResponse>({
        queryKey: ["casino-admin-reservations"],
      });
    ...
    onSuccess: (result) => {
      ...
      setSelectedId(null);
      queryClient.invalidateQueries({ queryKey: ["casino-admin-reservations"] });
      queryClient.invalidateQueries({ queryKey: ["casino-admin-reservation-detail"] });
    },
