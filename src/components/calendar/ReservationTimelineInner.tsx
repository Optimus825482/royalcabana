              ...
              ${sseConnected ? "bg-emerald-950/60 text-emerald-400 border border-emerald-800/40" : "bg-red-950/60 text-red-400 border border-red-800/40 animate-pulse"}`}
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-neutral-300 min-w-[180px] text-center">
                        {formatDateShort(startDate)} – {formatDateShort(addDays(endDate, -1))}
                    </span>
            ...
            >
                {isLoading ? (
                    ...
                    <div className="inline-block min-w-full">
                        ...
                        >
                            {/* Cabana name column */}
                            <div className="sticky left-0 z-30 flex items-center justify-center bg-neutral-900/95 backdrop-blur-sm border-r border-neutral-800/50 px-3"
                    ...
                    hover:bg-neutral-800/15`}
                      ...
                      ${rowIdx % 2 === 0 ? "bg-neutral-950/90" : "bg-neutral-900/90"}`}
                                    ...
                                    >
                                        {/* Status dot */}
                                        <div
                                            className={`w-2 h-2 rounded-full shrink-0 ${cabana.isOpenForReservation
                            ...
                            ${today ? "bg-amber-950/15" : weekend ? "bg-neutral-800/10" : ""}`}
                                                    ...
                                                    onClick={() =>
                                                        onCellClick?.(cabana.id, toDateStr(d))
                                                    }
                                                />
                                            );
                                        })}
