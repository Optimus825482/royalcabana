...
var registered = null;
function register(proj43) {
  registered = proj43;
  const projCodes = Object.keys(proj43.defs);
  const len = projCodes.length;
  let i, j;
  for (i = 0; i < len; ++i) {
    const code = projCodes[i];
    if (!get(code)) {
      const def = proj43.defs(code);
      let units = (
  ...
  for (i = 0; i < len; ++i) {
    ...
    for (j = 0; j < len; ++j) {
      ...
      if (!get2(code1, code2)) {
        if (proj43.defs[code1] === proj43.defs[code2]) {
          addEquivalentProjections([proj1, proj2]);
        } else {
          const transform2 = proj43(code1, code2);
          addCoordinateTransforms(
            proj1,
            proj2,
...
// node_modules/@giro3d/giro3d/core/geographic/SRID.js
var SRID = class _SRID {
...
// node_modules/@giro3d/giro3d/core/geographic/Unit.js
...
var _LinearUnit = class _LinearUnit {
...
__publicField(_LinearUnit, "meters", new _LinearUnit("meters", 1));
__publicField(_LinearUnit, "feet", new _LinearUnit("feet", 0.3048));
__publicField(_LinearUnit, "usSurveyFeet", new _LinearUnit("US Survey feet", 0.304800609601219));
var LinearUnit = _LinearUnit;
var _AngularUnit = class _AngularUnit {
  constructor(name, degreesPerUnit) {
    __publicField(this, "type", "angular");
    this.name = name;
...
__publicField(_AngularUnit, "degrees", new _AngularUnit("degrees", 1));
__publicField(_AngularUnit, "radians", new _AngularUnit("radians", 57.29578));
var AngularUnit = _AngularUnit;
...
// node_modules/@giro3d/giro3d/core/geographic/CoordinateSystem.js
...
var _CoordinateSystem = class _CoordinateSystem {
  /**
   ...
   */
  static register(id, definition, options) {
    ...
    try {
      ...
      if ((options == null ? void 0 : options.throwIfFailedToRegisterWithProj) === true) {
        throw error;
      } else {
        console.warn(error);
      }
    }
    const crs = _CoordinateSystem.fromWkt(definition, {
      id
    });
  ...
  static clearRegistry() {
    ...
    this._registry.set("EPSG:3857", _CoordinateSystem.epsg3857);
    this._registry.set("EPSG:4326", _CoordinateSystem.epsg4326);
    this._registry.set("EPSG:4978", _CoordinateSystem.epsg4978);
    this._registry.set("EPSG:4979", _CoordinateSystem.epsg4979);
    this._registry.set("equirectangular", _CoordinateSystem.equirectangular);
    this._registry.set("unknown", _CoordinateSystem.unknown);
  }
  /**
  ...
  static fromWkt(wkt, overrides) {
    try {
      let parsed;
      try {
        parsed = wkt_parser_default(wkt);
      } catch {
        parsed = parseCode_default(wkt);
      }
      if ("ID" in parsed) {
        return new _CoordinateSystem({
          id: overrides == null ? void 0 : overrides.id,
        ...
        return new _CoordinateSystem(parameters);
  ...
  constructor(params2) {
    ...
    this.srid = params2.srid;
    this._customId = params2.id;
    if (typeof params2.horizontal !== "undefined") {
      this.horizontal = params2.horizontal;
    }
    if (typeof params2.vertical !== "undefined") {
      this.vertical = params2.vertical;
    }
    if (typeof params2.definition !== "undefined") {
      this.definition = params2.definition;
    }
  }
  /**
  ...
  isGeographic() {
    var _a;
    const unit = (_a = this.horizontal) == null ? void 0 : _a.unit;
  ...
  get metersPerVerticalUnit() {
    var _a;
    const unit = (_a = this.vertical) == null ? void 0 : _a.unit;
    if (LinearUnit.isLinearUnit(unit)) {
      return unit.metersPerUnit;
    }
 ...
 */
__publicField(_CoordinateSystem, "epsg3857", new _CoordinateSystem({
...
__publicField(_CoordinateSystem, "epsg4326", new _CoordinateSystem({
  name: "WGS 84",
...
__publicField(_CoordinateSystem, "epsg4978", new _CoordinateSystem({
  name: "WGS 84",
...
__publicField(_CoordinateSystem, "epsg4979", new _CoordinateSystem({
  name: "WGS 84",
 ...
 */
__publicField(_CoordinateSystem, "equirectangular", new _CoordinateSystem({
  name: "equirectangular",
  horizontal: {
    unit: AngularUnit.degrees
  }
}));
__publicField(_CoordinateSystem, "unknown", new _CoordinateSystem({
  name: "unknown"
}));
__publicField(_CoordinateSystem, "_registry", /* @__PURE__ */ new Map([["EPSG:3857", _CoordinateSystem.epsg3857], ["EPSG:4326", _CoordinateSystem.epsg4326], ["EPSG:4978", _CoordinateSystem.epsg4978], ["EPSG:4979", _CoordinateSystem.epsg4979], ["equirectangular", _CoordinateSystem.equirectangular], ["unknown", _CoordinateSystem.unknown]]));
var CoordinateSystem = _CoordinateSystem;
...
//# sourceMappingURL=chunk-TW2BW7IN.js.map
