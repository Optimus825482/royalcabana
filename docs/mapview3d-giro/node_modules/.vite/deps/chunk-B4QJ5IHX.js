...
// node_modules/@giro3d/giro3d/core/Cache.js
var DEFAULT_MAX_ENTRIES = 8192;
var DEFAULT_TTL = 24e4;
var DEFAULT_CAPACITY = 536870912;
var Cache = class {
  /**
   * Constructs a cache.
   *
  ...
  constructor(opts) {
    ...
    this._deleteHandlers = /* @__PURE__ */ new Map();
    this._enabled = true;
    this._lru = this.createLRUCache(opts);
  }
  createLRUCache(opts) {
    return new LRUCache({
      ttl: (opts == null ? void 0 : opts.ttl) ?? DEFAULT_TTL,
      ttlResolution: 1e3,
      // 1 second
      updateAgeOnGet: true,
      maxSize: (opts == null ? void 0 : opts.byteCapacity) ?? DEFAULT_CAPACITY,
      max: (opts == null ? void 0 : opts.maxNumberOfEntries) ?? DEFAULT_MAX_ENTRIES,
      allowStale: false,
      dispose: (value, key) => {
...
//# sourceMappingURL=chunk-B4QJ5IHX.js.map
